"""Separator chunking: split on delimiter, length-split only inside overlong blocks.

Ported from YUSU ``yuxi.knowledge.chunking.ragflow_like.parsers.separator``.
"""
...
from yusu_kb.knowledge.chunking.parsers.general import (
    _iter_sections,
    _unescape_delimiter,
)
