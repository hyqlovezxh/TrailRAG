"""QA chunking: extract question-answer structure first.

Ported from YUSU ``yuxi.knowledge.chunking.ragflow_like.parsers.qa``.
"""
...
def chunk_markdown(filename: str, markdown_content: str, parser_config: dict[str, Any] | None = None) -> list[str]:
    ...
    if not pairs and lines:
        # Last-resort: pair up lines 2-by-2 as question/answer
