...
YUSU WebUI is a React-based web interface for interacting with the YUSU system. It provides a user-friendly interface for querying, managing, and exploring YUSU's functionalities.
...
2. **Install Dependencies:**
    ...
    In the `yusu_webui` directory, run the following command to install project dependencies:
...
3. **Build the Project:**
    ...
    This command will bundle the project and output the built files to the `yusu/api/webui` directory.
...
1. **Move the project into the Linux filesystem.** Clone/copy YUSU somewhere under your WSL home (e.g. `~/YUSU`) instead of `/mnt/c/...`, then reinstall:
