...
interface ImportMetaEnv {
   ...
   * into `index.html` as `window.__YUSU_CONFIG__`, mirroring what the
   ...
   *
   * See `yusu_webui/env.development.smaple` and
   ...
   *  `YUSU_API_PREFIX` if a real prefixed backend is being proxied to. */
